...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 847</li>
        <li>Games Played: 1,269,742</li>
        <li>Moves Made: 196,432,141</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 07:30:03 EDT (-0400)<!-- /last-updated --></p>
</section>
