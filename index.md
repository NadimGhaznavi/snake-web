...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 838</li>
        <li>Games Played: 1,256,121</li>
        <li>Moves Made: 194,454,279</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 02:30:03 EDT (-0400)<!-- /last-updated --></p>
</section>
