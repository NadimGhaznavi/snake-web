...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 120</li>
        <li>Simulation Runs: 850</li>
        <li>Games Played: 1,274,205</li>
        <li>Moves Made: 196,988,444</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 09:00:04 EDT (-0400)<!-- /last-updated --></p>
</section>
