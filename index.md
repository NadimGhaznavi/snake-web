...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 830</li>
        <li>Games Played: 1,244,769</li>
        <li>Moves Made: 192,759,909</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 22:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
