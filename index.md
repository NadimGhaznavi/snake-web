...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 913</li>
        <li>Games Played: 1,369,432</li>
        <li>Moves Made: 213,542,013</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 15:30:03 EDT (-0400)<!-- /last-updated --></p>
</section>
