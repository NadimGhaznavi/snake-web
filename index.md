...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 126</li>
        <li>Simulation Runs: 892</li>
        <li>Games Played: 1,337,902</li>
        <li>Moves Made: 208,055,641</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 13:00:04 EDT (-0400)<!-- /last-updated --></p>
</section>
