...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 775</li>
        <li>Games Played: 1,161,349</li>
        <li>Moves Made: 179,902,221</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-23 19:30:03 EDT (-0400)<!-- /last-updated --></p>
</section>
