...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 966</li>
        <li>Games Played: 1,448,497</li>
        <li>Moves Made: 225,758,752</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 20:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
