...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 115</li>
        <li>Simulation Runs: 815</li>
        <li>Games Played: 1,222,011</li>
        <li>Moves Made: 189,388,939</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 15:30:03 EDT (-0400)<!-- /last-updated --></p>
</section>
