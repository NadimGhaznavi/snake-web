...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 993</li>
        <li>Games Played: 1,489,484</li>
        <li>Moves Made: 231,770,946</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-26 03:00:05 EDT (-0400)<!-- /last-updated --></p>
</section>
