...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 816</li>
        <li>Games Played: 1,223,394</li>
        <li>Moves Made: 189,633,373</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 16:00:04 EDT (-0400)<!-- /last-updated --></p>
</section>
