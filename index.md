...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 978</li>
        <li>Games Played: 1,466,816</li>
        <li>Moves Made: 228,553,495</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 23:00:04 EDT (-0400)<!-- /last-updated --></p>
</section>
