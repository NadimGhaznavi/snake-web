...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 795</li>
        <li>Games Played: 1,192,352</li>
        <li>Moves Made: 184,843,451</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 06:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
