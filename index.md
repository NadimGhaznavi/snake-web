...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 845</li>
        <li>Games Played: 1,266,579</li>
        <li>Moves Made: 195,858,293</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 06:00:04 EDT (-0400)<!-- /last-updated --></p>
</section>
