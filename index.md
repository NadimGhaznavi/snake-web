...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 826</li>
        <li>Games Played: 1,237,899</li>
        <li>Moves Made: 191,764,585</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 20:30:03 EDT (-0400)<!-- /last-updated --></p>
</section>
