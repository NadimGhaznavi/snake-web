...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 139</li>
        <li>Simulation Runs: 987</li>
        <li>Games Played: 1,479,998</li>
        <li>Moves Made: 230,366,570</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-26 01:00:04 EDT (-0400)<!-- /last-updated --></p>
</section>
