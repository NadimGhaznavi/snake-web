...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 803</li>
        <li>Games Played: 1,204,125</li>
        <li>Moves Made: 186,595,470</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 10:30:06 EDT (-0400)<!-- /last-updated --></p>
</section>
