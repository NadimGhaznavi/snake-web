...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 794</li>
        <li>Games Played: 1,189,748</li>
        <li>Moves Made: 184,373,213</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 05:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
