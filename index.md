...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 824</li>
        <li>Games Played: 1,234,841</li>
        <li>Moves Made: 191,427,038</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 19:30:03 EDT (-0400)<!-- /last-updated --></p>
</section>
