...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 110</li>
        <li>Simulation Runs: 783</li>
        <li>Games Played: 1,173,328</li>
        <li>Moves Made: 181,740,165</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 00:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
