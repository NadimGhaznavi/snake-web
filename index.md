...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulations Run: 771</li>
        <li>Games Played: 1,156,196</li>
        <li>Moves Made: 179,007,676</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-23 17:24:04 EDT (-0400)<!-- /last-updated --></p>
</section>
