...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 833</li>
        <li>Games Played: 1,248,585</li>
        <li>Moves Made: 193,304,191</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 23:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
