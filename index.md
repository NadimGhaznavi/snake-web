...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 919</li>
        <li>Games Played: 1,378,500</li>
        <li>Moves Made: 215,062,704</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 16:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
