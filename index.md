...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 130</li>
        <li>Simulation Runs: 922</li>
        <li>Games Played: 1,382,386</li>
        <li>Moves Made: 215,725,943</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 16:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
