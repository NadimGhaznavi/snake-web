...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 808</li>
        <li>Games Played: 1,211,024</li>
        <li>Moves Made: 187,674,998</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 12:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
