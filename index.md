...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 825</li>
        <li>Games Played: 1,236,546</li>
        <li>Moves Made: 191,596,184</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 20:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
