...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 116</li>
        <li>Simulation Runs: 823</li>
        <li>Games Played: 1,233,485</li>
        <li>Moves Made: 191,204,587</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 19:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
