...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 998</li>
        <li>Games Played: 1,496,269</li>
        <li>Moves Made: 232,704,528</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-26 04:00:04 EDT (-0400)<!-- /last-updated --></p>
</section>
