...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 128</li>
        <li>Simulation Runs: 906</li>
        <li>Games Played: 1,358,843</li>
        <li>Moves Made: 211,680,417</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 14:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
