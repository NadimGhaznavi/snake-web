...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 989</li>
        <li>Games Played: 1,483,058</li>
        <li>Moves Made: 230,860,562</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-26 01:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
