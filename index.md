...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 837</li>
        <li>Games Played: 1,255,049</li>
        <li>Moves Made: 194,263,755</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 02:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
