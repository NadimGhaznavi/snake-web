...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 123</li>
        <li>Simulation Runs: 871</li>
        <li>Games Played: 1,305,410</li>
        <li>Moves Made: 202,414,289</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 11:00:05 EDT (-0400)<!-- /last-updated --></p>
</section>
