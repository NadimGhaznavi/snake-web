...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 112</li>
        <li>Simulation Runs: 796</li>
        <li>Games Played: 1,193,774</li>
        <li>Moves Made: 185,062,240</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 07:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
