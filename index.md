...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 822</li>
        <li>Games Played: 1,232,062</li>
        <li>Moves Made: 190,993,101</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 18:30:03 EDT (-0400)<!-- /last-updated --></p>
</section>
