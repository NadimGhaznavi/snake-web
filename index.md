...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 776</li>
        <li>Games Played: 1,162,527</li>
        <li>Moves Made: 180,129,484</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-23 20:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
