...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 848</li>
        <li>Games Played: 1,271,787</li>
        <li>Moves Made: 196,722,473</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 08:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
