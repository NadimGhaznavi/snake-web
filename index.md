...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 843</li>
        <li>Games Played: 1,264,219</li>
        <li>Moves Made: 195,614,492</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 05:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
