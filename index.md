...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 137</li>
        <li>Simulation Runs: 975</li>
        <li>Games Played: 1,461,364</li>
        <li>Moves Made: 227,769,147</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 22:00:04 EDT (-0400)<!-- /last-updated --></p>
</section>
