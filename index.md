...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 798</li>
        <li>Games Played: 1,196,350</li>
        <li>Moves Made: 185,509,850</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 08:00:04 EDT (-0400)<!-- /last-updated --></p>
</section>
