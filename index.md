...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 125</li>
        <li>Simulation Runs: 888</li>
        <li>Games Played: 1,330,948</li>
        <li>Moves Made: 206,804,296</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 12:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
