...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 801</li>
        <li>Games Played: 1,201,344</li>
        <li>Moves Made: 186,135,795</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 09:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
