...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 140</li>
        <li>Simulation Runs: 991</li>
        <li>Games Played: 1,486,401</li>
        <li>Moves Made: 231,334,637</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-26 02:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
