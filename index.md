...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 902</li>
        <li>Games Played: 1,353,000</li>
        <li>Moves Made: 210,671,893</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 14:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
