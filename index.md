...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 114</li>
        <li>Simulation Runs: 806</li>
        <li>Games Played: 1,208,555</li>
        <li>Moves Made: 187,329,690</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 12:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
