...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 138</li>
        <li>Simulation Runs: 976</li>
        <li>Games Played: 1,463,622</li>
        <li>Moves Made: 228,166,311</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 22:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
