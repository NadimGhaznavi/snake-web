...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 834</li>
        <li>Games Played: 1,249,968</li>
        <li>Moves Made: 193,480,921</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 00:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
