...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 142</li>
        <li>Simulation Runs: 1005</li>
        <li>Games Played: 1,506,500</li>
        <li>Moves Made: 234,443,022</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-26 06:00:04 EDT (-0400)<!-- /last-updated --></p>
</section>
