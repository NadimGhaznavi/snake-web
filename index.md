...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 127</li>
        <li>Simulation Runs: 898</li>
        <li>Games Played: 1,346,646</li>
        <li>Moves Made: 209,576,620</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 13:30:03 EDT (-0400)<!-- /last-updated --></p>
</section>
