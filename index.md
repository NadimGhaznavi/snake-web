...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 131</li>
        <li>Simulation Runs: 929</li>
        <li>Games Played: 1,393,500</li>
        <li>Moves Made: 217,650,119</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 17:30:03 EDT (-0400)<!-- /last-updated --></p>
</section>
