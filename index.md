...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 109</li>
        <li>Simulation Runs: 774</li>
        <li>Games Played: 1,159,980</li>
        <li>Moves Made: 179,678,332</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-23 19:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
