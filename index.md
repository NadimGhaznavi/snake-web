...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 970</li>
        <li>Games Played: 1,454,816</li>
        <li>Moves Made: 226,877,666</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 21:00:04 EDT (-0400)<!-- /last-updated --></p>
</section>
