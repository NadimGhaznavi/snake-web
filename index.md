...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 809</li>
        <li>Games Played: 1,212,867</li>
        <li>Moves Made: 187,938,787</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 13:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
