...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 773</li>
        <li>Games Played: 1,158,713</li>
        <li>Moves Made: 179,458,083</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-23 18:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
