...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 124</li>
        <li>Simulation Runs: 877</li>
        <li>Games Played: 1,314,104</li>
        <li>Moves Made: 203,917,058</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 11:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
