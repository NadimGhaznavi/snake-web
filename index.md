...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 778</li>
        <li>Games Played: 1,166,652</li>
        <li>Moves Made: 180,652,831</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-23 21:30:03 EDT (-0400)<!-- /last-updated --></p>
</section>
