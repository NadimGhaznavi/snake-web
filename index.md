...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 113</li>
        <li>Simulation Runs: 799</li>
        <li>Games Played: 1,197,801</li>
        <li>Moves Made: 185,672,156</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 08:30:03 EDT (-0400)<!-- /last-updated --></p>
</section>
