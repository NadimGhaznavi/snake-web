...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 772</li>
        <li>Games Played: 1,157,578</li>
        <li>Moves Made: 179,256,120</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-23 18:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
