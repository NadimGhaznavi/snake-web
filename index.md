...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 129</li>
        <li>Simulation Runs: 912</li>
        <li>Games Played: 1,368,000</li>
        <li>Moves Made: 213,295,716</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 15:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
