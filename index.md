...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 789</li>
        <li>Games Played: 1,182,468</li>
        <li>Moves Made: 183,120,245</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 03:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
