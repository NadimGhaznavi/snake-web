...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 982</li>
        <li>Games Played: 1,473,000</li>
        <li>Moves Made: 229,543,687</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-26 00:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
