...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 135</li>
        <li>Simulation Runs: 956</li>
        <li>Games Played: 1,432,533</li>
        <li>Moves Made: 223,477,803</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 19:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
