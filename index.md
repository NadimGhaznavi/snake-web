...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 111</li>
        <li>Simulation Runs: 788</li>
        <li>Games Played: 1,181,067</li>
        <li>Moves Made: 182,876,534</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 02:30:03 EDT (-0400)<!-- /last-updated --></p>
</section>
