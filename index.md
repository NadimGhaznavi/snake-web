...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 812</li>
        <li>Games Played: 1,217,778</li>
        <li>Moves Made: 188,657,983</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 14:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
