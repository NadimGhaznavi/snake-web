...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 133</li>
        <li>Simulation Runs: 943</li>
        <li>Games Played: 1,413,611</li>
        <li>Moves Made: 220,686,668</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 18:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
