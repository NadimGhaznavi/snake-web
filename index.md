...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 984</li>
        <li>Games Played: 1,475,872</li>
        <li>Moves Made: 229,905,854</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-26 00:30:05 EDT (-0400)<!-- /last-updated --></p>
</section>
