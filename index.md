...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Completed Experiments: 136</li>
        <li>Simulation Runs: 961</li>
        <li>Games Played: 1,441,500</li>
        <li>Moves Made: 224,696,873</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-25 20:00:04 EDT (-0400)<!-- /last-updated --></p>
</section>
