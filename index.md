...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 792</li>
        <li>Games Played: 1,187,552</li>
        <li>Moves Made: 184,029,133</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-24 05:00:03 EDT (-0400)<!-- /last-updated --></p>
</section>
