...
<section class="snake-experiment" aria-label="Experiment overview">
  <figure class="experiment-board" aria-label="Current highscore snapshot and experiment metrics">
    ...
    <figcaption>
      <ul class="experiment-metrics">
        ...
        <li>Simulation Runs: 996</li>
        <li>Games Played: 1,493,111</li>
        <li>Moves Made: 232,225,389</li>
      </ul>
    </figcaption>
  </figure>
  ...
  Last Updated: <!-- last-updated -->2026-09-26 03:30:04 EDT (-0400)<!-- /last-updated --></p>
</section>
